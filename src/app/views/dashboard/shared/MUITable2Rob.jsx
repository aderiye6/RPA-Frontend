...
export default function MUITable2Rob({}) {
        ...
        },
        {
            ...
            render: (rowData) => (
                ...
                >
                    ...
                    <StyledItem>
                        <Icon> Force Stop </Icon>
                        <Span> Force Stop </Span>
                    </StyledItem>
                    <StyledItem
                    // onClick={logout}
                    >
                        <Icon> Force Disconnect </Icon>
                        <Span> Force Disconnect </Span>
                    </StyledItem>
                    <StyledItem>
                        <Icon> Generate Token </Icon>
                        <Span> Generate Token</Span>
                    </StyledItem>
                    <StyledItem>
                        <Icon> Revoke token </Icon>
                        <Span> Revoke token </Span>
                    </StyledItem>
                    <StyledItem>
                        <Icon> Inject vault secret </Icon>
                        <Span> Inject vault secret </Span>
                    </StyledItem>
                </MatxMenu>
            ),
        },
