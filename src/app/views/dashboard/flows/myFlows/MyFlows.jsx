...
import { MatxLoading, MatxMenu } from 'app/components'
import {
    Avatar,
    FormControl,
    FormControlLabel,
...
export default function MyFlows({ robotData, refetch, refetchSetter, isConsoleProject }) {
        ...
        },
        {
            ...
            render: (rowData) => (
                ...
                >
                    ...
                    <StyledItem>
                        <div onClick={()=> deleteFlow(rowData.id)}> <Icon> Delete</Icon>
